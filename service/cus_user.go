...
func cGetUserInfoList(info request.PageInfo) (err error, list interface{}, total int64) {
	limit := info.PageSize
...
func cSetUserAuthority(uuid uuid.UUID, authorityId string) (err error) {
...
func cDeleteUser(id float64) (err error) {
...
func cSetUserInfo(reqUser model.SysUser) (err error, user model.SysUser) {
...
func cFindUserById(id int) (err error, user *model.SysUser) {
	var u model.SysUser
