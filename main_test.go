...
func (s SystemMenus) ConvertToINodeArray() (nodes []utils.INode) {
	for _, v := range s {
...
func TestGenerateTree(t *testing.T) {
	...
	// resp = utils.GenerateTree(SystemMenus.ConvertToINodeArray(allMenu), SystemMenus.ConvertToINodeArray(selectedNode))
